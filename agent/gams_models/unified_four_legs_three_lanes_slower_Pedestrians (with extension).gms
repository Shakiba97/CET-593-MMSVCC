...
$gdxin %gdxincname%
$load i j l k vehicle_indi m h d_0 k_dynamics lane_length veh_dynamics gamma s_init wt_init p_init ped_Demand Gp EW NS
$gdxin
...
$offtext
cost..                                                                           f =e= 0.5*[f_throughput + f_dist/100 + f_transit*5 + f_delay/50] + 0.5*[5*f_ped_throughput/40];
